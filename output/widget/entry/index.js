...
var _workflowWorkflow = require('ops:widget/workflow/workflow.jsx');

var _workflowWorkflow2 = _interopRequireDefault(_workflowWorkflow);

var _workflowProcedureStart = require('ops:widget/workflow/procedureStart.jsx');

var _workflowProcedureStart2 = _interopRequireDefault(_workflowProcedureStart);

var _workflowOwnProce = require('ops:widget/workflow/ownProce.jsx');

var _workflowOwnProce2 = _interopRequireDefault(_workflowOwnProce);

var _workflowPendingProce = require('ops:widget/workflow/pendingProce.jsx');

var _workflowPendingProce2 = _interopRequireDefault(_workflowPendingProce);

var _workflowDefineProce = require('ops:widget/workflow/defineProce.jsx');

var _workflowDefineProce2 = _interopRequireDefault(_workflowDefineProce);
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						_reactRouter.Route,
						{ path: 'workflow', component: _workflowWorkflow2['default'] },
						_react2['default'].createElement(_reactRouter.Route, { path: 'proceStart', component: _workflowProcedureStart2['default'] }),
						_react2['default'].createElement(_reactRouter.Route, { path: 'ownProce', component: _workflowProcedureStart2['default'] }),
						_react2['default'].createElement(_reactRouter.Route, { path: 'pendingProce', component: _workflowPendingProce2['default'] }),
						_react2['default'].createElement(_reactRouter.Route, { path: 'defineProce', component: _workflowDefineProce2['default'] })
					)
				)
			)
		);
